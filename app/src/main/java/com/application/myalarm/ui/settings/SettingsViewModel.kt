...
class SettingsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _alarmRemindersPermissionGranted = MutableStateFlow(checkAlarmRemindersPermissionInternal(application))
    val alarmRemindersPermissionGranted: StateFlow<Boolean> = _alarmRemindersPermissionGranted.asStateFlow()
    ...
    fun checkAlarmRemindersPermission(context: Context) {
        _alarmRemindersPermissionGranted.value = checkAlarmRemindersPermissionInternal(context)
    }
    ...
    private fun checkAlarmRemindersPermissionInternal(context: Context): Boolean {
