...
fun TimePickerBottomSheet(
    ...
    val hourCenter = if (is24HourFormat) {
        BUFFER_SIZE / 2 - (BUFFER_SIZE / 2 % 24) + initialHour
    } else {
        BUFFER_SIZE / 2 - (BUFFER_SIZE / 2 % 12) + (initialDisplay12 - 1)
    }
        ...
        Surface(
            ...
            Column(
                ...
                Box(
                    ...
                    Box(
                        modifier = Modifier
                            .fillMaxWidth(if (is24HourFormat) 0.65f else 0.85f)
                    ...
                    Row(
                        ...
                        WheelColumn(
                            ...
                            getLabel = { index ->
                                if (is24HourFormat) {
                                    String.format("%02d", hours24[index % 24])
                                } else {
                                    hours12[index % 12].toString()
                                }
                            },
                            modifier = Modifier
                                .width(80.dp)
                ...
                Button(
                    onClick = {
                        ...
                        val hour24 = if (is24HourFormat) {
                            hours24[selectedHourIndex % 24]
                        } else {
                            val selectedHour12 = hours12[selectedHourIndex % 12]
