...
object Localizer {
    ...
    private val translations = mapOf(
        ...
        "Are you tired of oversleeping and hitting snooze repeatedly? Riser is designed to wake you up completely. To silence the alarm, you must complete interactive missions (solving math problems, shaking the phone, taking photos of the sky, or walking a specified step count). Once the alarm triggers, navigation controls are restricted to ensure you don't cheat!" to mapOf(
        ...
        "Hi! I am the creator of this alarm application. I developed Riser to help you break bad sleeping habits, cultivate morning self-discipline, and get out of bed on time with engaging wake-up missions. Thank you for choosing my app to master your mornings!" to mapOf(
...
,
        ...
        "Complete Setup & Enter App" to mapOf(
            Language.CHINESE_SIMPLIFIED to "完成设置并进入应用",
            Language.CHINESE_TRADITIONAL to "完成設置並進入應用",
            Language.CHINESE_PINYIN to "Wán chéng shè zhì bìng jìn rù yìng yòng",
            Language.ARABIC to "إكمال الإعداد والدخول إلى التطبيق",
            Language.TAGALOG to "Kumpletuhin ang Setup at Pumasok sa App",
            Language.THAI to "เสร็จสิ้นการตั้งค่าและเข้าสู่แอป",
            Language.HINDI to "सेटअप पूरा करें और ऐप में प्रवेश करें",
            Language.CANTONESE to "完成設定並進入應用"
        ),
        "Download via Browser" to mapOf(
            Language.CHINESE_SIMPLIFIED to "通过浏览器下载",
            Language.CHINESE_TRADITIONAL to "通過瀏覽器下載",
            Language.CHINESE_PINYIN to "Tōng guò liú lǎn qì xià zǎi",
            Language.ARABIC to "التنزيل عبر المتصفح",
            Language.TAGALOG to "I-download gamit ang Browser",
            Language.THAI to "ดาวน์โหลดผ่านเบราว์เซอร์",
            Language.HINDI to "ब्राउज़र के माध्यम से डाउनलोड करें",
            Language.CANTONESE to "通過瀏覽器下載"
        ),
        "Shake Difficulty Level" to mapOf(
            Language.CHINESE_SIMPLIFIED to "摇晃难度等级",
            Language.CHINESE_TRADITIONAL to "搖晃難度等級",
            Language.CHINESE_PINYIN to "Yáo huàng nán dù děng jí",
            Language.ARABIC to "مستوى صعوبة الهز",
            Language.TAGALOG to "Antas ng Kahirapan sa Pag-alog",
            Language.THAI to "ระดับความยากในการเขย่า",
            Language.HINDI to "हिलाने का कठिनाई स्तर",
            Language.CANTONESE to "搖晃難度等級"
        ),
        "shakes required" to mapOf(
            Language.CHINESE_SIMPLIFIED to "需要摇晃次数",
            Language.CHINESE_TRADITIONAL to "需要搖晃次數",
            Language.CHINESE_PINYIN to "xū yào yáo huàng cì shù",
            Language.ARABIC to "عدد الهزات المطلوبة",
            Language.TAGALOG to "kailangang alog",
            Language.THAI to "จำนวนการเขย่าที่ต้องการ",
            Language.HINDI to "आवश्यक हिलाव",
            Language.CANTONESE to "需要搖晃次數"
        ),
        "Easy" to mapOf(
            Language.CHINESE_SIMPLIFIED to "简单",
            Language.CHINESE_TRADITIONAL to "簡單",
            Language.CHINESE_PINYIN to "Jiǎn dān",
            Language.ARABIC to "سهل",
            Language.TAGALOG to "Madali",
            Language.THAI to "ง่าย",
            Language.HINDI to "आसान",
            Language.CANTONESE to "簡單"
        ),
        "Simple" to mapOf(
            Language.CHINESE_SIMPLIFIED to "基础",
            Language.CHINESE_TRADITIONAL to "基礎",
            Language.CHINESE_PINYIN to "Jī chǔ",
            Language.ARABIC to "بسيط",
            Language.TAGALOG to "Simpling Alog",
            Language.THAI to "พื้นฐาน",
            Language.HINDI to "साधारण",
            Language.CANTONESE to "基礎"
        ),
        "Moderate" to mapOf(
            Language.CHINESE_SIMPLIFIED to "中等",
            Language.CHINESE_TRADITIONAL to "中等",
            Language.CHINESE_PINYIN to "Zhōng děng",
            Language.ARABIC to "متوسط",
            Language.TAGALOG to "Katamtaman",
            Language.THAI to "ปานกลาง",
            Language.HINDI to "मध्यम",
            Language.CANTONESE to "中等"
        ),
        "Hard" to mapOf(
            Language.CHINESE_SIMPLIFIED to "困难",
            Language.CHINESE_TRADITIONAL to "困難",
            Language.CHINESE_PINYIN to "Kùn nán",
            Language.ARABIC to "صعب",
            Language.TAGALOG to "Mahirap",
            Language.THAI to "ยาก",
            Language.HINDI to "कठिन",
            Language.CANTONESE to "困難"
        ),
        "Extreme" to mapOf(
            Language.CHINESE_SIMPLIFIED to "极限",
            Language.CHINESE_TRADITIONAL to "極限",
            Language.CHINESE_PINYIN to "Jí xiàn",
            Language.ARABIC to "شديد للغاية",
            Language.TAGALOG to "Sobra",
            Language.THAI to "ขั้นสุด",
            Language.HINDI to "अत्यधिक",
            Language.CANTONESE to "極限"
        ),
        "Analyzing photo with AI..." to mapOf(
            Language.CHINESE_SIMPLIFIED to "正在使用AI分析照片...",
            Language.CHINESE_TRADITIONAL to "正在使用AI分析照片...",
            Language.CHINESE_PINYIN to "Zhèng zài shǐ yòng AI fēn xī zhào piàn...",
            Language.ARABIC to "جاري تحليل الصورة بالذكاء الاصطناعي...",
            Language.TAGALOG to "Sinusuri ang larawan gamit ang AI...",
            Language.THAI to "กำลังวิเคราะห์ภาพด้วย AI...",
            Language.HINDI to "एआई के साथ फोटो का विश्लेषण किया जा रहा है...",
            Language.CANTONESE to "正在使用AI分析照片..."
        ),
        "Indoor bed structure detected! Please step outside and capture the open morning sky." to mapOf(
            Language.CHINESE_SIMPLIFIED to "检测到室内床铺！请到室外拍摄早晨的天空。",
            Language.CHINESE_TRADITIONAL to "檢測到室內床鋪！請到室外拍攝早晨的天空。",
            Language.CHINESE_PINYIN to "Jiǎn cè dào shì nèi chuáng pù! Qǐng dào shì wài pāi zhào zǎo chen de tiān kōng.",
            Language.ARABIC to "تم اكتشاف سرير داخلي! يرجى الخروج والتقاط صورة لسمائي الصباح.",
            Language.TAGALOG to "Na-detect ang kama sa loob! Mangyaring lumabas at kumuha ng larawan ng langit sa umaga.",
            Language.THAI to "ตรวจพบโครงสร้างเตียงในร่ม! กรุณาออกไปข้างนอกและถ่ายภาพท้องฟ้าในตอนเช้า",
            Language.HINDI to "इनडोर बिस्तर का पता चला! कृपया बाहर जाएं और सुबह के खुले आसमान की तस्वीर लें।",
            Language.CANTONESE to "檢測到室內床鋪！請到室外拍攝早晨的天空。"
        ),
        "Sky not recognized! Point your camera towards the open morning sky." to mapOf(
            Language.CHINESE_SIMPLIFIED to "未识别到天空！请将相机对准早晨的开放天空。",
            Language.CHINESE_TRADITIONAL to "未識別到天空！請將相機對準早晨的開放天空。",
            Language.CHINESE_PINYIN to "Wèi shí bié dào tiān kōng! Qǐng jiāng xiàng jī duì zhǔn zǎo chen de kāi fàng tiān kōng.",
            Language.ARABIC to "لم يتم التعرف على السماء! وجه الكاميرا نحو سماء الصباح المفتوحة.",
            Language.TAGALOG to "Hindi na-recognize ang langit! Ipatukoy ang camera sa bukas na langit sa umaga.",
            Language.THAI to "ไม่รู้จักท้องฟ้า! ชี้กล้องของคุณไปยังท้องฟ้าในตอนเช้า",
            Language.HINDI to "आसमान पहचाना नहीं गया! अपने कैमरे को सुबह के खुले आसमान की ओर घुमाएँ।",
            Language.CANTONESE to "未識別到天空！請將相機對準早晨的開放天空。"
        ),
        "Only available for AM alarms" to mapOf(
            Language.CHINESE_SIMPLIFIED to "仅适用于上午闹钟",
            Language.CHINESE_TRADITIONAL to "僅適用於上午鬧鐘",
            Language.CHINESE_PINYIN to "Jǐn shì yòng yú shàng wǔ nào zhōng",
            Language.ARABIC to "متاح فقط للمنبهات الصباحية (AM)",
            Language.TAGALOG to "Magagamit lamang para sa AM na alarms",
            Language.THAI to "ใช้งานได้เฉพาะนาฬิกาปลุกช่วงเช้า (AM)",
            Language.HINDI to "केवल एएम अलार्म के लिए उपलब्ध है",
            Language.CANTONESE to "僅適用於上午鬧鐘"
        )
)

    fun t(key: String): String {
        val lang = currentLanguage
        if (key.startsWith("Day_") && key.endsWith("_Acronym")) {
            val acronym = when (key) {
                "Day_Mon_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Mon"
                    Language.CHINESE_SIMPLIFIED -> "周一"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週一"
                    Language.CHINESE_PINYIN -> "Yī"
                    Language.ARABIC -> "إثنين"
                    Language.THAI -> "จ."
                    Language.HINDI -> "सोम"
                }
                "Day_Tue_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Tue"
                    Language.CHINESE_SIMPLIFIED -> "周二"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週二"
                    Language.CHINESE_PINYIN -> "Èr"
                    Language.ARABIC -> "ثلاثاء"
                    Language.THAI -> "อ."
                    Language.HINDI -> "मंगल"
                }
                "Day_Wed_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Wed"
                    Language.CHINESE_SIMPLIFIED -> "周三"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週三"
                    Language.CHINESE_PINYIN -> "Sān"
                    Language.ARABIC -> "أربعاء"
                    Language.THAI -> "พ."
                    Language.HINDI -> "बुध"
                }
                "Day_Thu_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Thu"
                    Language.CHINESE_SIMPLIFIED -> "周四"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週四"
                    Language.CHINESE_PINYIN -> "Sì"
                    Language.ARABIC -> "خميس"
                    Language.THAI -> "พฤ."
                    Language.HINDI -> "गुरु"
                }
                "Day_Fri_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Fri"
                    Language.CHINESE_SIMPLIFIED -> "周五"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週五"
                    Language.CHINESE_PINYIN -> "Wǔ"
                    Language.ARABIC -> "جمعة"
                    Language.THAI -> "ศ."
                    Language.HINDI -> "शुक्र"
                }
                "Day_Sat_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Sat"
                    Language.CHINESE_SIMPLIFIED -> "周六"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週六"
                    Language.CHINESE_PINYIN -> "Liù"
                    Language.ARABIC -> "سبت"
                    Language.THAI -> "ส."
                    Language.HINDI -> "शनि"
                }
                "Day_Sun_Acronym" -> when (lang) {
                    Language.ENGLISH, Language.TAGALOG -> "Sun"
                    Language.CHINESE_SIMPLIFIED -> "周日"
                    Language.CHINESE_TRADITIONAL, Language.CANTONESE -> "週日"
