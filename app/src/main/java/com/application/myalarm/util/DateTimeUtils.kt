...
object DateTimeUtils {
    ...
    fun formatRepeatDays(repeatDays: Int): String {
        ...
        val acronyms = listOf(
            Localizer.t("Day_Mon_Acronym"),
            Localizer.t("Day_Tue_Acronym"),
            Localizer.t("Day_Wed_Acronym"),
            Localizer.t("Day_Thu_Acronym"),
            Localizer.t("Day_Fri_Acronym"),
            Localizer.t("Day_Sat_Acronym"),
            Localizer.t("Day_Sun_Acronym")
        )

        return acronyms.mapIndexed { index, acronym ->
            if (repeatDays and (1 shl index) != 0) acronym else null
